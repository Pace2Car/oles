    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">查询单选题</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="ques/searchRadio" method="post">
...
<script>
    ...
    function add(){
        ...
        $.post("ques/toAdd?examNo="+examNo+"&singleId="+value,function (json) {
            if (json.actionFlag) {
                $('#successAlert').show();
