        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">查询判断题</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                        ...
                        <tr class="page-nav" style="text-align: center">
                            <td colspan='5'>
                                ...
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchJudge?pageNum=1">第一页</a> &nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchJudge?pageNum=${ques.getPageNum()-1}">上一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchJudge?pageNum=${ques.getPageNum()+1}">下一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchJudge?pageNum=${ques.getPages()}">末页</a>&nbsp;
                                </c:if>
                            </td>
                        </tr>
                    </table>
...
<script>
    ...
    function add(){
        ...
        $.post("ques/toAdd?examNo="+examNo+"&trueFalseId="+value,function (json) {
            if (json.actionFlag) {
                $('#successAlert').show();
                setTimeout("$('#successAlert').hide()", 3000);
            } else {
