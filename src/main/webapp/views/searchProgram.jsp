    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">查询编程题</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="ques/searchProgram" method="post">
                                ...
                                <div class="ibox-content" style="display: none">
                                    <table class="table table-hover no-margins">
                                        ...
                                        <tr id="trR_${questions.id}">
                                            <td>&nbsp;&nbsp;标准答案：&nbsp;&nbsp;
                                                <span style="color: black">${questions.stdAnswer}</span></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;
                        ...
                        <tr class="page-nav" style="text-align: center">
                            <td colspan='5'>
                                ...
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchProgram?pageNum=1">第一页</a> &nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchProgram?pageNum=${ques.getPageNum()-1}">上一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchProgram?pageNum=${ques.getPageNum()+1}">下一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchProgram?pageNum=${ques.getPages()}">末页</a>&nbsp;
                                </c:if>
                            </td>
                        </tr>
                    </table>
...
<script>
    ...
    function toUpdate(e) {
        ...
        var no = $(e).attr('no');
        $.get('ques/toUpdateProgram/' + no, function (html) {
            console.dirxml(html)
    ...
    function toDelete(e) {
        ...
        $("#deleteConfirmBtn").click(function () {
            $("#div_" + id).remove();
            $.get("ques/deleteFsp?id=" + id, function (json) {
                if (json.actionFlag) {
                    $('#successAlert').show();
    ...
    function add(){
        ...
        $.post("ques/toAdd?examNo="+examNo+"&programId="+value,function (json) {
            if (json.actionFlag) {
                $('#successAlert').show();
                setTimeout("$('#successAlert').hide()", 3000);
            } else {
