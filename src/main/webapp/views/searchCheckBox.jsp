                            ...
                            <div class="ibox float-e-margins border-bottom">
                                ...
                                <div class="ibox-content" style="display: none">
                                    <table class="table table-hover no-margins">
                                        ...
                                        <tr id="trE_${questions.id}">
                                            <td>&nbsp;&nbsp;E.&nbsp;&nbsp;
                                                <span style="color: black">${optList.get(questions.id).optionE}</span>
                                            </td>
                                        </tr>
...
<script>
    ...
    function toUpdate(e) {
        ...
        var no = $(e).attr('no');
        $.get('ques/toUpdateCheckBox/' + no, function (html) {
            console.dirxml(html)
    ...
    function add(){
        ...
        $.post("ques/toAdd?examNo="+examNo+"&multipleId="+value,function (json) {
            if (json.actionFlag) {
                $('#successAlert').show();
                setTimeout("$('#successAlert').hide()", 3000);
            } else {
