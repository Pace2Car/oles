            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-outline btn-warning" onclick="maintain()">阅卷</button>
                    </div>
                </div>
...
<script>
    ...
    function maintain(){
        ...
        location.href="examManage/subjectiveList?examNo="+examNo;
    };
</script>
