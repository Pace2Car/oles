    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">查询简答题</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="ques/searchShort" method="post">
                        ...
                        <tr class="page-nav" style="text-align: center">
                            <td colspan='5'>
                                ...
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchShort?pageNum=1">第一页</a> &nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() gt 1}">
                                    <a href="ques/searchShort?pageNum=${ques.getPageNum()-1}">上一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchShort?pageNum=${ques.getPageNum()+1}">下一页</a>&nbsp;
                                </c:if>
                                <c:if test="${ques.getPageNum() lt ques.getPages()}">
                                    <a href="ques/searchShort?pageNum=${ques.getPages()}">末页</a>&nbsp;
                                </c:if>
                            </td>
                        </tr>
                    </table>
...
<script>
    ...
    function toUpdate(e) {
        ...
        var no = $(e).attr('no');
        $.get('ques/toUpdateShort/' + no, function (html) {
            console.dirxml(html)
