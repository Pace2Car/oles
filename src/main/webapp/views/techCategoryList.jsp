                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                    <thead>
                                    <tr role="row">
                                        <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="知识点ID: activate to sort column descending" style="width: 238px;" aria-sort="ascending">知识点ID</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="知识点名称: activate to sort column ascending" style="width: 417px;">知识点名称</th>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">知识点名称</th>
