        ...
        <form action="user/login" method="post" class="form-horizontal" role="form">
            <div class="form-group">
                <div style="margin-left: 60px" class="input-group input-group-lg">
                    ...
                    <input style="width: 550px;" type="text" class="form-control" id="loginName" name="userName" value="james" placeholder="请输入用户名">
                </div>
            </div>
            ...
            <div class="form-group">
                <div style="margin-left: 60px" class="input-group input-group-lg">
                    ...
                    <input style="width: 550px;" type="password" class="form-control" id="password" name="password" value="james" placeholder="请输入密码">
                </div>
            </div>
            <div class="clearfix"></div>
            <br>
